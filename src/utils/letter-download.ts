import type { LetterDocument } from '@/types/two-letters-one-order';

export function formatLetterFileSize(size: number) {
...
BT /F1 14 Tf 72 720 Td (Letter: ${label}) Tj ET
endstream
endobj
...
export function downloadLetterDoc(doc: LetterDocument) {
