...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function nm(i,e,t){const n=new Float32Array(Kn),s=new P(0,1,0);return new fn({name:"SphericalGaussianBlur",defines:{n:Kn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:sr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Rl(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Cl(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sr(),fragmentShader:`
...
`)}const o_={[rc]:"Linear",[ac]:"Reinhard",[oc]:"Cineon",[lc]:"ACESFilmic",[hc]:"AgX",[uc]:"Neutral",[cc]:"Custom"};function l_(i,e){const t=o_[e];return t===void 0?(Fe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Fs=new P;function c_(){je.getLuminanceCoefficients(Fs);const i=Fs.x.toFixed(4),e=Fs.y.toFixed(4),t=Fs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function h_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yi).join(`
`)}function u_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function f_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Yi(i){return i!==""}function zl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function kl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const d_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ga(i){return i.replace(d_,m_)}const p_=new Map;function m_(i,e){let t=qe[e];if(t===void 0){const n=p_.get(e);if(n!==void 0)t=qe[n],Fe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Ga(t)}const __=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Vl(i){return i.replace(__,g_)}function g_(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Gl(i){let e=`precision ${i.precision} float;
...
`].filter(Yi).join(`
`)),a=Ga(a),a=zl(a,t),a=kl(a,t),o=Ga(o),o=zl(o,t),o=kl(o,t),a=Vl(a),o=Vl(o),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+d);const A=E+m+a,S=E+d+o,w=Fl(s,s.VERTEX_SHADER,A),b=Fl(s,s.FRAGMENT_SHADER,S);s.attachShader(v,w),s.attachShader(v,b),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function R(C){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(v)||"",X=s.getShaderInfoLog(w)||"",q=s.getShaderInfoLog(b)||"",L=O.trim(),B=X.trim(),N=q.trim();let W=!0,K=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(W=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,w,b);else{const ie=Bl(s,w,"vertex"),ae=Bl(s,b,"fragment");Qe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,W_=[new P(1,0,0),new P(-1,0,0),new P(0,1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1)],X_=[new P(0,-1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1),new P(0,-1,0),new P(0,-1,0)],ql=new ct,Wi=new P,qr=new P;function q_(i,e,t){let n=new so;const s=new re,r=new re,a=new dt,o=new ju,l=new ef,c={},u=t.maxTextureSize,p={[Bn]:zt,[zt]:Bn,[vn]:vn},h=new fn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new re},radius:{value:4}},vertexShader:G_,fragmentShader:H_}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const _=new It;_.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Bt(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zs;let d=this.type;this.render=function(b,R,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===ah&&(Fe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=zs);const T=i.getRenderTarget(),I=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),O=i.state;O.setBlending(yn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const X=d!==this.type;X&&R.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(L=>L.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,L=b.length;q<L;q++){const B=b[q],N=B.shadow;if(N===void 0){Fe("WebGLShadowMap:",B,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;s.copy(N.mapSize);const W=N.getFrameExtents();s.multiply(W),r.copy(N.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/W.x),s.x=r.x*W.x,N.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/W.y),s.y=r.y*W.y,N.mapSize.y=r.y));const K=i.state.buffers.depth.getReversed();if(N.camera._reversedDepth=K,N.map===null||X===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===Xi){if(B.isPointLight){Fe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new cn(s.x,s.y,{format:jn,type:bn,minFilter:Lt,magFilter:Lt,generateMipmaps:!1}),N.map.texture.name=B.name+".shadowMap",N.map.depthTexture=new Di(s.x,s.y,an),N.map.depthTexture.name=B.name+".shadowMapDepth",N.map.depthTexture.format=Tn,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=Rt,N.map.depthTexture.magFilter=Rt}else B.isPointLight?(N.map=new Vc(s.x),N.map.depthTexture=new fu(s.x,un)):(N.map=new cn(s.x,s.y),N.map.depthTexture=new Di(s.x,s.y,un)),N.map.depthTexture.name=B.name+".shadowMap",N.map.depthTexture.format=Tn,this.type===zs?(N.map.depthTexture.compareFunction=K?eo:ja,N.map.depthTexture.minFilter=Lt,N.map.depthTexture.magFilter=Lt):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=Rt,N.map.depthTexture.magFilter=Rt);N.camera.updateProjectionMatrix()}const ie=N.map.isWebGLCubeRenderTarget?6:1;for(let ae=0;ae<ie;ae++){if(N.map.isWebGLCubeRenderTarget)i.setRenderTarget(N.map,ae),i.clear();else{ae===0&&(i.setRenderTarget(N.map),i.clear());const Se=N.getViewport(ae);a.set(r.x*Se.x,r.y*Se.y,r.x*Se.z,r.y*Se.w),O.viewport(a)}if(B.isPointLight){const Se=N.camera,He=N.matrix,nt=B.distance||Se.far;nt!==Se.far&&(Se.far=nt,Se.updateProjectionMatrix()),Wi.setFromMatrixPosition(B.matrixWorld),Se.position.copy(Wi),qr.copy(Se.position),qr.add(W_[ae]),Se.up.copy(X_[ae]),Se.lookAt(qr),Se.updateMatrixWorld(),He.makeTranslation(-Wi.x,-Wi.y,-Wi.z),ql.multiplyMatrices(Se.projectionMatrix,Se.matrixWorldInverse),N._frustum.setFromProjectionMatrix(ql,Se.coordinateSystem,Se.reversedDepth)}else N.updateMatrices(B);n=N.getFrustum(),S(R,x,N.camera,B,this.type)}N.isPointLightShadow!==!0&&this.type===Xi&&E(N,x),N.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(T,I,C)};function E(b,R){const x=e.update(v);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new cn(s.x,s.y,{format:jn,type:bn})),h.uniforms.shadow_pass.value=b.map.depthTexture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(R,null,x,h,v,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(R,null,x,f,v,null)}function A(b,R,x,T){let I=null;const C=x.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)I=C;else if(I=x.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const O=I.uuid,X=R.uuid;let q=c[O];q===void 0&&(q={},c[O]=q);let L=q[X];L===void 0&&(L=I.clone(),q[X]=L,R.addEventListener("dispose",w)),I=L}if(I.visible=R.visible,I.wireframe=R.wireframe,T===Xi?I.side=R.shadowSide!==null?R.shadowSide:R.side:I.side=R.shadowSide!==null?R.shadowSide:p[R.side],I.alphaMap=R.alphaMap,I.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,I.map=R.map,I.clipShadows=R.clipShadows,I.clippingPlanes=R.clippingPlanes,I.clipIntersection=R.clipIntersection,I.displacementMap=R.displacementMap,I.displacementScale=R.displacementScale,I.displacementBias=R.displacementBias,I.wireframeLinewidth=R.wireframeLinewidth,I.linewidth=R.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const O=i.properties.get(I);O.light=x}return I}function S(b,R,x,T,I){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&I===Xi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,b.matrixWorld);const X=e.update(b),q=b.material;if(Array.isArray(q)){const L=X.groups;for(let B=0,N=L.length;B<N;B++){const W=L[B],K=q[W.materialIndex];if(K&&K.visible){const ie=A(b,K,T,I);b.onBeforeShadow(i,b,R,x,X,ie,W),i.renderBufferDirect(x,null,X,ie,b,W),b.onAfterShadow(i,b,R,x,X,ie,W)}}}else if(q.visible){const L=A(b,q,T,I);b.onBeforeShadow(i,b,R,x,X,L,null),i.renderBufferDirect(x,null,X,L,b,null),b.onAfterShadow(i,b,R,x,X,L,null)}}const O=b.children;for(let X=0,q=O.length;X<q;X++)S(O[X],R,x,T,I)}function w(b){b.target.removeEventListener("dispose",w);for(const x in c){const T=c[x],I=b.target.uuid;I in T&&(T[I].dispose(),delete T[I])}}}function Y_(i,e){function t(){let U=!1;const he=new dt;let $=null;const de=new dt(0,0,0,0);return{setMask:function(Me){$!==Me&&!U&&(i.colorMask(Me,Me,Me,Me),$=Me)},setLocked:function(Me){U=Me},setClear:function(Me,ee,Ae,be,mt){mt===!0&&(Me*=be,ee*=be,Ae*=be),he.set(Me,ee,Ae,be),de.equals(he)===!1&&(i.clearColor(Me,ee,Ae,be),de.copy(he))},reset:function(){U=!1,$=null,de.set(-1,0,0,0)}}}function n(){let U=!1,he=!1,$=null,de=null,Me=null;return{setReversed:function(ee){if(he!==ee){const Ae=e.get("EXT_clip_control");ee?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),he=ee;const be=Me;Me=null,this.setClear(be)}},getReversed:function(){return he},setTest:function(ee){ee?se(i.DEPTH_TEST):Pe(i.DEPTH_TEST)},setMask:function(ee){$!==ee&&!U&&(i.depthMask(ee),$=ee)},setFunc:function(ee){if(he&&(ee=zh[ee]),de!==ee){switch(ee){case $r:i.depthFunc(i.NEVER);break;case Jr:i.depthFunc(i.ALWAYS);break;case Qr:i.depthFunc(i.LESS);break;case Ci:i.depthFunc(i.LEQUAL);break;case jr:i.depthFunc(i.EQUAL);break;case ea:i.depthFunc(i.GEQUAL);break;case ta:i.depthFunc(i.GREATER);break;case na:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}de=ee}},setLocked:function(ee){U=ee},setClear:function(ee){Me!==ee&&(Me=ee,he&&(ee=1-ee),i.clearDepth(ee))},reset:function(){U=!1,$=null,de=null,Me=null,he=!1}}}function s(){let U=!1,he=null,$=null,de=null,Me=null,ee=null,Ae=null,be=null,mt=null;return{setTest:function(ht){U||(ht?se(i.STENCIL_TEST):Pe(i.STENCIL_TEST))},setMask:function(ht){he!==ht&&!U&&(i.stencilMask(ht),he=ht)},setFunc:function(ht,jt,en){($!==ht||de!==jt||Me!==en)&&(i.stencilFunc(ht,jt,en),$=ht,de=jt,Me=en)},setOp:function(ht,jt,en){(ee!==ht||Ae!==jt||be!==en)&&(i.stencilOp(ht,jt,en),ee=ht,Ae=jt,be=en)},setLocked:function(ht){U=ht},setClear:function(ht){mt!==ht&&(i.clearStencil(ht),mt=ht)},reset:function(){U=!1,he=null,$=null,de=null,Me=null,ee=null,Ae=null,be=null,mt=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},p={},h={},f=new WeakMap,_=[],v=null,m=!1,d=null,E=null,A=null,S=null,w=null,b=null,R=null,x=new Ye(0,0,0),T=0,I=!1,C=null,O=null,X=null,q=null,L=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,W=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(K)[1]),N=W>=1):K.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),N=W>=2);let ie=null,ae={};const Se=i.getParameter(i.SCISSOR_BOX),He=i.getParameter(i.VIEWPORT),nt=new dt().fromArray(Se),$e=new dt().fromArray(He);function J(U,he,$,de){const Me=new Uint8Array(4),ee=i.createTexture();i.bindTexture(U,ee),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ae=0;Ae<$;Ae++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(he,0,i.RGBA,1,1,de,0,i.RGBA,i.UNSIGNED_BYTE,Me):i.texImage2D(he+Ae,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Me);return ee}const ce={};ce[i.TEXTURE_2D]=J(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=J(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[i.TEXTURE_2D_ARRAY]=J(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=J(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(i.DEPTH_TEST),a.setFunc(Ci),ge(!1),pe(Lo),se(i.CULL_FACE),ne(yn);function se(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function Pe(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function Be(U,he){return h[U]!==he?(i.bindFramebuffer(U,he),h[U]=he,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=he),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=he),!0):!1}function Ie(U,he){let $=_,de=!1;if(U){$=f.get(he),$===void 0&&($=[],f.set(he,$));const Me=U.textures;if($.length!==Me.length||$[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,Ae=Me.length;ee<Ae;ee++)$[ee]=i.COLOR_ATTACHMENT0+ee;$.length=Me.length,de=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,de=!0);de&&i.drawBuffers($)}function tt(U){return v!==U?(i.useProgram(U),v=U,!0):!1}const ke={[Zn]:i.FUNC_ADD,[lh]:i.FUNC_SUBTRACT,[ch]:i.FUNC_REVERSE_SUBTRACT};ke[hh]=i.MIN,ke[uh]=i.MAX;const j={[fh]:i.ZERO,[dh]:i.ONE,[ph]:i.SRC_COLOR,[Zr]:i.SRC_ALPHA,[Mh]:i.SRC_ALPHA_SATURATE,[xh]:i.DST_COLOR,[_h]:i.DST_ALPHA,[mh]:i.ONE_MINUS_SRC_COLOR,[Kr]:i.ONE_MINUS_SRC_ALPHA,[vh]:i.ONE_MINUS_DST_COLOR,[gh]:i.ONE_MINUS_DST_ALPHA,[Sh]:i.CONSTANT_COLOR,[yh]:i.ONE_MINUS_CONSTANT_COLOR,[Eh]:i.CONSTANT_ALPHA,[bh]:i.ONE_MINUS_CONSTANT_ALPHA};function ne(U,he,$,de,Me,ee,Ae,be,mt,ht){if(U===yn){m===!0&&(Pe(i.BLEND),m=!1);return}if(m===!1&&(se(i.BLEND),m=!0),U!==oh){if(U!==d||ht!==I){if((E!==Zn||w!==Zn)&&(i.blendEquation(i.FUNC_ADD),E=Zn,w=Zn),ht)switch(U){case Ai:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Io:i.blendFunc(i.ONE,i.ONE);break;case Uo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case No:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Qe("WebGLState: Invalid blending: ",U);break}else switch(U){case Ai:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Io:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Uo:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case No:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",U);break}A=null,S=null,b=null,R=null,x.set(0,0,0),T=0,d=U,I=ht}return}Me=Me||he,ee=ee||$,Ae=Ae||de,(he!==E||Me!==w)&&(i.blendEquationSeparate(ke[he],ke[Me]),E=he,w=Me),($!==A||de!==S||ee!==b||Ae!==R)&&(i.blendFuncSeparate(j[$],j[de],j[ee],j[Ae]),A=$,S=de,b=ee,R=Ae),(be.equals(x)===!1||mt!==T)&&(i.blendColor(be.r,be.g,be.b,mt),x.copy(be),T=mt),d=U,I=!1}function te(U,he){U.side===vn?Pe(i.CULL_FACE):se(i.CULL_FACE);let $=U.side===zt;he&&($=!$),ge($),U.blending===Ai&&U.transparent===!1?ne(yn):ne(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const de=U.stencilWrite;o.setTest(de),de&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),we(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?se(i.SAMPLE_ALPHA_TO_COVERAGE):Pe(i.SAMPLE_ALPHA_TO_COVERAGE)}function ge(U){C!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),C=U)}function pe(U){U!==sh?(se(i.CULL_FACE),U!==O&&(U===Lo?i.cullFace(i.BACK):U===rh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Pe(i.CULL_FACE),O=U}function Ne(U){U!==X&&(N&&i.lineWidth(U),X=U)}function we(U,he,$){U?(se(i.POLYGON_OFFSET_FILL),(q!==he||L!==$)&&(q=he,L=$,a.getReversed()&&(he=-he),i.polygonOffset(he,$))):Pe(i.POLYGON_OFFSET_FILL)}function ze(U){U?se(i.SCISSOR_TEST):Pe(i.SCISSOR_TEST)}function Ve(U){U===void 0&&(U=i.TEXTURE0+B-1),ie!==U&&(i.activeTexture(U),ie=U)}function D(U,he,$){$===void 0&&(ie===null?$=i.TEXTURE0+B-1:$=ie);let de=ae[$];de===void 0&&(de={type:void 0,texture:void 0},ae[$]=de),(de.type!==U||de.texture!==he)&&(ie!==$&&(i.activeTexture($),ie=$),i.bindTexture(U,he||ce[U]),de.type=U,de.texture=he)}function st(){const U=ae[ie];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Je(){try{i.compressedTexImage2D(...arguments)}catch(U){Qe("WebGLState:",U)}}function y(){try{i.compressedTexImage3D(...arguments)}catch(U){Qe("WebGLState:",U)}}function g(){try{i.texSubImage2D(...arguments)}catch(U){Qe("WebGLState:",U)}}function z(){try{i.texSubImage3D(...arguments)}catch(U){Qe("WebGLState:",U)}}function G(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Qe("WebGLState:",U)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Qe("WebGLState:",U)}}function oe(){try{i.texStorage2D(...arguments)}catch(U){Qe("WebGLState:",U)}}function le(){try{i.texStorage3D(...arguments)}catch(U){Qe("WebGLState:",U)}}function Z(){try{i.texImage2D(...arguments)}catch(U){Qe("WebGLState:",U)}}function Q(){try{i.texImage3D(...arguments)}catch(U){Qe("WebGLState:",U)}}function ue(U){return p[U]!==void 0?p[U]:i.getParameter(U)}function Re(U,he){p[U]!==he&&(i.pixelStorei(U,he),p[U]=he)}function me(U){nt.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),nt.copy(U))}function fe(U){$e.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),$e.copy(U))}function Le(U,he){let $=c.get(he);$===void 0&&($=new WeakMap,c.set(he,$));let de=$.get(U);de===void 0&&(de=i.getUniformBlockIndex(he,U.name),$.set(U,de))}function Oe(U,he){const de=c.get(he).get(U);l.get(he)!==de&&(i.uniformBlockBinding(he,de,U.__bindingPointIndex),l.set(he,de))}function We(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},p={},ie=null,ae={},h={},f=new WeakMap,_=[],v=null,m=!1,d=null,E=null,A=null,S=null,w=null,b=null,R=null,x=new Ye(0,0,0),T=0,I=!1,C=null,O=null,X=null,q=null,L=null,nt.set(0,0,i.canvas.width,i.canvas.height),$e.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:se,disable:Pe,bindFramebuffer:Be,drawBuffers:Ie,useProgram:tt,setBlending:ne,setMaterial:te,setFlipSided:ge,setCullFace:pe,setLineWidth:Ne,setPolygonOffset:we,setScissorTest:ze,activeTexture:Ve,bindTexture:D,unbindTexture:st,compressedTexImage2D:Je,compressedTexImage3D:y,texImage2D:Z,texImage3D:Q,pixelStorei:Re,getParameter:ue,updateUBOMapping:Le,uniformBlockBinding:Oe,texStorage2D:oe,texStorage3D:le,texSubImage2D:g,texSubImage3D:z,compressedTexSubImage2D:G,compressedTexSubImage3D:Y,scissor:me,viewport:fe,reset:We}}function Z_(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new re,u=new WeakMap,p=new Set;let h;const f=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(y,g){return _?new OffscreenCanvas(y,g):Ks("canvas")}function m(y,g,z){let G=1;const Y=Je(y);if((Y.width>z||Y.height>z)&&(G=z/Math.max(Y.width,Y.height)),G<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const oe=Math.floor(G*Y.width),le=Math.floor(G*Y.height);h===void 0&&(h=v(oe,le));const Z=g?v(oe,le):h;return Z.width=oe,Z.height=le,Z.getContext("2d").drawImage(y,0,0,oe,le),Fe("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+oe+"x"+le+")."),Z}else return"data"in y&&Fe("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),y;return y}function d(y){return y.generateMipmaps}function E(y){i.generateMipmap(y)}function A(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(y,g,z,G,Y,oe=!1){if(y!==null){if(i[y]!==void 0)return i[y];Fe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let le;G&&(le=e.get("EXT_texture_norm16"),le||Fe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=g;if(g===i.RED&&(z===i.FLOAT&&(Z=i.R32F),z===i.HALF_FLOAT&&(Z=i.R16F),z===i.UNSIGNED_BYTE&&(Z=i.R8),z===i.UNSIGNED_SHORT&&le&&(Z=le.R16_EXT),z===i.SHORT&&le&&(Z=le.R16_SNORM_EXT)),g===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.R8UI),z===i.UNSIGNED_SHORT&&(Z=i.R16UI),z===i.UNSIGNED_INT&&(Z=i.R32UI),z===i.BYTE&&(Z=i.R8I),z===i.SHORT&&(Z=i.R16I),z===i.INT&&(Z=i.R32I)),g===i.RG&&(z===i.FLOAT&&(Z=i.RG32F),z===i.HALF_FLOAT&&(Z=i.RG16F),z===i.UNSIGNED_BYTE&&(Z=i.RG8),z===i.UNSIGNED_SHORT&&le&&(Z=le.RG16_EXT),z===i.SHORT&&le&&(Z=le.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RG8UI),z===i.UNSIGNED_SHORT&&(Z=i.RG16UI),z===i.UNSIGNED_INT&&(Z=i.RG32UI),z===i.BYTE&&(Z=i.RG8I),z===i.SHORT&&(Z=i.RG16I),z===i.INT&&(Z=i.RG32I)),g===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RGB8UI),z===i.UNSIGNED_SHORT&&(Z=i.RGB16UI),z===i.UNSIGNED_INT&&(Z=i.RGB32UI),z===i.BYTE&&(Z=i.RGB8I),z===i.SHORT&&(Z=i.RGB16I),z===i.INT&&(Z=i.RGB32I)),g===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(Z=i.RGBA16UI),z===i.UNSIGNED_INT&&(Z=i.RGBA32UI),z===i.BYTE&&(Z=i.RGBA8I),z===i.SHORT&&(Z=i.RGBA16I),z===i.INT&&(Z=i.RGBA32I)),g===i.RGB&&(z===i.UNSIGNED_SHORT&&le&&(Z=le.RGB16_EXT),z===i.SHORT&&le&&(Z=le.RGB16_SNORM_EXT),z===i.UNSIGNED_INT_5_9_9_9_REV&&(Z=i.RGB9_E5),z===i.UNSIGNED_INT_10F_11F_11F_REV&&(Z=i.R11F_G11F_B10F)),g===i.RGBA){const Q=oe?Zs:je.getTransfer(Y);z===i.FLOAT&&(Z=i.RGBA32F),z===i.HALF_FLOAT&&(Z=i.RGBA16F),z===i.UNSIGNED_BYTE&&(Z=Q===it?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT&&le&&(Z=le.RGBA16_EXT),z===i.SHORT&&le&&(Z=le.RGBA16_SNORM_EXT),z===i.UNSIGNED_SHORT_4_4_4_4&&(Z=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(Z=i.RGB5_A1)}return(Z===i.R16F||Z===i.R32F||Z===i.RG16F||Z===i.RG32F||Z===i.RGBA16F||Z===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function w(y,g){let z;return y?g===null||g===un||g===Qi?z=i.DEPTH24_STENCIL8:g===an?z=i.DEPTH32F_STENCIL8:g===Ji&&(z=i.DEPTH24_STENCIL8,Fe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===un||g===Qi?z=i.DEPTH_COMPONENT24:g===an?z=i.DEPTH_COMPONENT32F:g===Ji&&(z=i.DEPTH_COMPONENT16),z}function b(y,g){return d(y)===!0||y.isFramebufferTexture&&y.minFilter!==Rt&&y.minFilter!==Lt?Math.log2(Math.max(g.width,g.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?g.mipmaps.length:1}function R(y){const g=y.target;g.removeEventListener("dispose",R),T(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&p.delete(g)}function x(y){const g=y.target;g.removeEventListener("dispose",x),C(g)}function T(y){const g=n.get(y);if(g.__webglInit===void 0)return;const z=y.source,G=f.get(z);if(G){const Y=G[g.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&I(y),Object.keys(G).length===0&&f.delete(z)}n.remove(y)}function I(y){const g=n.get(y);i.deleteTexture(g.__webglTexture);const z=y.source,G=f.get(z);delete G[g.__cacheKey],a.memory.textures--}function C(y){const g=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(g.__webglFramebuffer[G]))for(let Y=0;Y<g.__webglFramebuffer[G].length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[G][Y]);else i.deleteFramebuffer(g.__webglFramebuffer[G]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[G])}else{if(Array.isArray(g.__webglFramebuffer))for(let G=0;G<g.__webglFramebuffer.length;G++)i.deleteFramebuffer(g.__webglFramebuffer[G]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let G=0;G<g.__webglColorRenderbuffer.length;G++)g.__webglColorRenderbuffer[G]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[G]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const z=y.textures;for(let G=0,Y=z.length;G<Y;G++){const oe=n.get(z[G]);oe.__webglTexture&&(i.deleteTexture(oe.__webglTexture),a.memory.textures--),n.remove(z[G])}n.remove(y)}let O=0;function X(){O=0}function q(){return O}function L(y){O=y}function B(){const y=O;return y>=s.maxTextures&&Fe("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+s.maxTextures),O+=1,y}function N(y){const g=[];return g.push(y.wrapS),g.push(y.wrapT),g.push(y.wrapR||0),g.push(y.magFilter),g.push(y.minFilter),g.push(y.anisotropy),g.push(y.internalFormat),g.push(y.format),g.push(y.type),g.push(y.generateMipmaps),g.push(y.premultiplyAlpha),g.push(y.flipY),g.push(y.unpackAlignment),g.push(y.colorSpace),g.join()}function W(y,g){const z=n.get(y);if(y.isVideoTexture&&D(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&z.__version!==y.version){const G=y.image;if(G===null)Fe("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)Fe("WebGLRenderer: Texture marked for update but image is incomplete");else{Pe(z,y,g);return}}else y.isExternalTexture&&(z.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+g)}function K(y,g){const z=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&z.__version!==y.version){Pe(z,y,g);return}else y.isExternalTexture&&(z.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+g)}function ie(y,g){const z=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&z.__version!==y.version){Pe(z,y,g);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+g)}function ae(y,g){const z=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&z.__version!==y.version){Be(z,y,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+g)}const Se={[ia]:i.REPEAT,[Mn]:i.CLAMP_TO_EDGE,[sa]:i.MIRRORED_REPEAT},He={[Rt]:i.NEAREST,[wh]:i.NEAREST_MIPMAP_NEAREST,[ls]:i.NEAREST_MIPMAP_LINEAR,[Lt]:i.LINEAR,[ur]:i.LINEAR_MIPMAP_NEAREST,[$n]:i.LINEAR_MIPMAP_LINEAR},nt={[Ph]:i.NEVER,[Nh]:i.ALWAYS,[Dh]:i.LESS,[ja]:i.LEQUAL,[Lh]:i.EQUAL,[eo]:i.GEQUAL,[Ih]:i.GREATER,[Uh]:i.NOTEQUAL};function $e(y,g){if(g.type===an&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Lt||g.magFilter===ur||g.magFilter===ls||g.magFilter===$n||g.minFilter===Lt||g.minFilter===ur||g.minFilter===ls||g.minFilter===$n)&&Fe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,Se[g.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,Se[g.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,Se[g.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,He[g.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,He[g.minFilter]),g.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,nt[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Rt||g.minFilter!==ls&&g.minFilter!==$n||g.type===an&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function J(y,g){let z=!1;y.__webglInit===void 0&&(y.__webglInit=!0,g.addEventListener("dispose",R));const G=g.source;let Y=f.get(G);Y===void 0&&(Y={},f.set(G,Y));const oe=N(g);if(oe!==y.__cacheKey){Y[oe]===void 0&&(Y[oe]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),Y[oe].usedTimes++;const le=Y[y.__cacheKey];le!==void 0&&(Y[y.__cacheKey].usedTimes--,le.usedTimes===0&&I(g)),y.__cacheKey=oe,y.__webglTexture=Y[oe].texture}return z}function ce(y,g,z){return Math.floor(Math.floor(y/z)/g)}function se(y,g,z,G){const oe=y.updateRanges;if(oe.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,z,G,g.data);else{oe.sort((Re,me)=>Re.start-me.start);let le=0;for(let Re=1;Re<oe.length;Re++){const me=oe[le],fe=oe[Re],Le=me.start+me.count,Oe=ce(fe.start,g.width,4),We=ce(me.start,g.width,4);fe.start<=Le+1&&Oe===We&&ce(fe.start+fe.count-1,g.width,4)===Oe?me.count=Math.max(me.count,fe.start+fe.count-me.start):(++le,oe[le]=fe)}oe.length=le+1;const Z=t.getParameter(i.UNPACK_ROW_LENGTH),Q=t.getParameter(i.UNPACK_SKIP_PIXELS),ue=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Re=0,me=oe.length;Re<me;Re++){const fe=oe[Re],Le=Math.floor(fe.start/4),Oe=Math.ceil(fe.count/4),We=Le%g.width,U=Math.floor(Le/g.width),he=Oe,$=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,We),t.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,We,U,he,$,z,G,g.data)}y.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Z),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(i.UNPACK_SKIP_ROWS,ue)}}function Pe(y,g,z){let G=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(G=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(G=i.TEXTURE_3D);const Y=J(y,g),oe=g.source;t.bindTexture(G,y.__webglTexture,i.TEXTURE0+z);const le=n.get(oe);if(oe.version!==le.__version||Y===!0){if(t.activeTexture(i.TEXTURE0+z),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const $=je.getPrimaries(je.workingColorSpace),de=g.colorSpace===Fn?null:je.getPrimaries(g.colorSpace),Me=g.colorSpace===Fn||$===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let Q=m(g.image,!1,s.maxTextureSize);Q=st(g,Q);const ue=r.convert(g.format,g.colorSpace),Re=r.convert(g.type);let me=S(g.internalFormat,ue,Re,g.normalized,g.colorSpace,g.isVideoTexture);$e(G,g);let fe;const Le=g.mipmaps,Oe=g.isVideoTexture!==!0,We=le.__version===void 0||Y===!0,U=oe.dataReady,he=b(g,Q);if(g.isDepthTexture)me=w(g.format===Jn,g.type),We&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,me,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,me,Q.width,Q.height,0,ue,Re,null));else if(g.isDataTexture)if(Le.length>0){Oe&&We&&t.texStorage2D(i.TEXTURE_2D,he,me,Le[0].width,Le[0].height);for(let $=0,de=Le.length;$<de;$++)fe=Le[$],Oe?U&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,fe.width,fe.height,ue,Re,fe.data):t.texImage2D(i.TEXTURE_2D,$,me,fe.width,fe.height,0,ue,Re,fe.data);g.generateMipmaps=!1}else Oe?(We&&t.texStorage2D(i.TEXTURE_2D,he,me,Q.width,Q.height),U&&se(g,Q,ue,Re)):t.texImage2D(i.TEXTURE_2D,0,me,Q.width,Q.height,0,ue,Re,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Oe&&We&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,me,Le[0].width,Le[0].height,Q.depth);for(let $=0,de=Le.length;$<de;$++)if(fe=Le[$],g.format!==Qt)if(ue!==null)if(Oe){if(U)if(g.layerUpdates.size>0){const Me=El(fe.width,fe.height,g.format,g.type);for(const ee of g.layerUpdates){const Ae=fe.data.subarray(ee*Me/fe.data.BYTES_PER_ELEMENT,(ee+1)*Me/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,ee,fe.width,fe.height,1,ue,Ae)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,fe.width,fe.height,Q.depth,ue,fe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,me,fe.width,fe.height,Q.depth,0,fe.data,0,0);else Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?U&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,fe.width,fe.height,Q.depth,ue,Re,fe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,$,me,fe.width,fe.height,Q.depth,0,ue,Re,fe.data)}else{Oe&&We&&t.texStorage2D(i.TEXTURE_2D,he,me,Le[0].width,Le[0].height);for(let $=0,de=Le.length;$<de;$++)fe=Le[$],g.format!==Qt?ue!==null?Oe?U&&t.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,fe.width,fe.height,ue,fe.data):t.compressedTexImage2D(i.TEXTURE_2D,$,me,fe.width,fe.height,0,fe.data):Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?U&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,fe.width,fe.height,ue,Re,fe.data):t.texImage2D(i.TEXTURE_2D,$,me,fe.width,fe.height,0,ue,Re,fe.data)}else if(g.isDataArrayTexture)if(Oe){if(We&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,me,Q.width,Q.height,Q.depth),U)if(g.layerUpdates.size>0){const $=El(Q.width,Q.height,g.format,g.type);for(const de of g.layerUpdates){const Me=Q.data.subarray(de*$/Q.data.BYTES_PER_ELEMENT,(de+1)*$/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,de,Q.width,Q.height,1,ue,Re,Me)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ue,Re,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,me,Q.width,Q.height,Q.depth,0,ue,Re,Q.data);else if(g.isData3DTexture)Oe?(We&&t.texStorage3D(i.TEXTURE_3D,he,me,Q.width,Q.height,Q.depth),U&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ue,Re,Q.data)):t.texImage3D(i.TEXTURE_3D,0,me,Q.width,Q.height,Q.depth,0,ue,Re,Q.data);else if(g.isFramebufferTexture){if(We)if(Oe)t.texStorage2D(i.TEXTURE_2D,he,me,Q.width,Q.height);else{let $=Q.width,de=Q.height;for(let Me=0;Me<he;Me++)t.texImage2D(i.TEXTURE_2D,Me,me,$,de,0,ue,Re,null),$>>=1,de>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const $=i.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),Q.parentNode!==$){$.appendChild(Q),p.add(g),$.onpaint=de=>{const Me=de.changedElements;for(const ee of p)Me.includes(ee.image)&&(ee.needsUpdate=!0)},$.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,Q);else{const Me=i.RGBA,ee=i.RGBA,Ae=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Me,ee,Ae,Q)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Le.length>0){if(Oe&&We){const $=Je(Le[0]);t.texStorage2D(i.TEXTURE_2D,he,me,$.width,$.height)}for(let $=0,de=Le.length;$<de;$++)fe=Le[$],Oe?U&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ue,Re,fe):t.texImage2D(i.TEXTURE_2D,$,me,ue,Re,fe);g.generateMipmaps=!1}else if(Oe){if(We){const $=Je(Q);t.texStorage2D(i.TEXTURE_2D,he,me,$.width,$.height)}U&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,Re,Q)}else t.texImage2D(i.TEXTURE_2D,0,me,ue,Re,Q);d(g)&&E(G),le.__version=oe.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function Be(y,g,z){if(g.image.length!==6)return;const G=J(y,g),Y=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+z);const oe=n.get(Y);if(Y.version!==oe.__version||G===!0){t.activeTexture(i.TEXTURE0+z);const le=je.getPrimaries(je.workingColorSpace),Z=g.colorSpace===Fn?null:je.getPrimaries(g.colorSpace),Q=g.colorSpace===Fn||le===Z?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const ue=g.isCompressedTexture||g.image[0].isCompressedTexture,Re=g.image[0]&&g.image[0].isDataTexture,me=[];for(let ee=0;ee<6;ee++)!ue&&!Re?me[ee]=m(g.image[ee],!0,s.maxCubemapSize):me[ee]=Re?g.image[ee].image:g.image[ee],me[ee]=st(g,me[ee]);const fe=me[0],Le=r.convert(g.format,g.colorSpace),Oe=r.convert(g.type),We=S(g.internalFormat,Le,Oe,g.normalized,g.colorSpace),U=g.isVideoTexture!==!0,he=oe.__version===void 0||G===!0,$=Y.dataReady;let de=b(g,fe);$e(i.TEXTURE_CUBE_MAP,g);let Me;if(ue){U&&he&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,We,fe.width,fe.height);for(let ee=0;ee<6;ee++){Me=me[ee].mipmaps;for(let Ae=0;Ae<Me.length;Ae++){const be=Me[Ae];g.format!==Qt?Le!==null?U?$&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,0,0,be.width,be.height,Le,be.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,We,be.width,be.height,0,be.data):Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,0,0,be.width,be.height,Le,Oe,be.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,We,be.width,be.height,0,Le,Oe,be.data)}}}else{if(Me=g.mipmaps,U&&he){Me.length>0&&de++;const ee=Je(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,We,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Re){U?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,me[ee].width,me[ee].height,Le,Oe,me[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,We,me[ee].width,me[ee].height,0,Le,Oe,me[ee].data);for(let Ae=0;Ae<Me.length;Ae++){const mt=Me[Ae].image[ee].image;U?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,0,0,mt.width,mt.height,Le,Oe,mt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,We,mt.width,mt.height,0,Le,Oe,mt.data)}}else{U?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Le,Oe,me[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,We,Le,Oe,me[ee]);for(let Ae=0;Ae<Me.length;Ae++){const be=Me[Ae];U?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,0,0,Le,Oe,be.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,We,Le,Oe,be.image[ee])}}}d(g)&&E(i.TEXTURE_CUBE_MAP),oe.__version=Y.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function Ie(y,g,z,G,Y,oe){const le=r.convert(z.format,z.colorSpace),Z=r.convert(z.type),Q=S(z.internalFormat,le,Z,z.normalized,z.colorSpace),ue=n.get(g),Re=n.get(z);if(Re.__renderTarget=g,!ue.__hasExternalTextures){const me=Math.max(1,g.width>>oe),fe=Math.max(1,g.height>>oe);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?t.texImage3D(Y,oe,Q,me,fe,g.depth,0,le,Z,null):t.texImage2D(Y,oe,Q,me,fe,0,le,Z,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),Ve(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,G,Y,Re.__webglTexture,0,ze(g)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,G,Y,Re.__webglTexture,oe),t.bindFramebuffer(i.FRAMEBUFFER,null)}function tt(y,g,z){if(i.bindRenderbuffer(i.RENDERBUFFER,y),g.depthBuffer){const G=g.depthTexture,Y=G&&G.isDepthTexture?G.type:null,oe=w(g.stencilBuffer,Y),le=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Ve(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ze(g),oe,g.width,g.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,ze(g),oe,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,oe,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,le,i.RENDERBUFFER,y)}else{const G=g.textures;for(let Y=0;Y<G.length;Y++){const oe=G[Y],le=r.convert(oe.format,oe.colorSpace),Z=r.convert(oe.type),Q=S(oe.internalFormat,le,Z,oe.normalized,oe.colorSpace);Ve(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ze(g),Q,g.width,g.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,ze(g),Q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Q,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ke(y,g,z){const G=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Y=n.get(g.depthTexture);if(Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),G){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,g.depthTexture.addEventListener("dispose",R)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),$e(i.TEXTURE_CUBE_MAP,g.depthTexture);const ue=r.convert(g.depthTexture.format),Re=r.convert(g.depthTexture.type);let me;g.depthTexture.format===Tn?me=i.DEPTH_COMPONENT24:g.depthTexture.format===Jn&&(me=i.DEPTH24_STENCIL8);for(let fe=0;fe<6;fe++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,me,g.width,g.height,0,ue,Re,null)}}else W(g.depthTexture,0);const oe=Y.__webglTexture,le=ze(g),Z=G?i.TEXTURE_CUBE_MAP_POSITIVE_X+z:i.TEXTURE_2D,Q=g.depthTexture.format===Jn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===Tn)Ve(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Z,oe,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Z,oe,0);else if(g.depthTexture.format===Jn)Ve(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Z,oe,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Z,oe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function j(y){const g=n.get(y),z=y.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==y.depthTexture){const G=y.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),G){const Y=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,G.removeEventListener("dispose",Y)};G.addEventListener("dispose",Y),g.__depthDisposeCallback=Y}g.__boundDepthTexture=G}if(y.depthTexture&&!g.__autoAllocateDepthBuffer)if(z)for(let G=0;G<6;G++)ke(g.__webglFramebuffer[G],y,G);else{const G=y.texture.mipmaps;G&&G.length>0?ke(g.__webglFramebuffer[0],y,0):ke(g.__webglFramebuffer,y,0)}else if(z){g.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[G]),g.__webglDepthbuffer[G]===void 0)g.__webglDepthbuffer[G]=i.createRenderbuffer(),tt(g.__webglDepthbuffer[G],y,!1);else{const Y=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=g.__webglDepthbuffer[G];i.bindRenderbuffer(i.RENDERBUFFER,oe),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,oe)}}else{const G=y.texture.mipmaps;if(G&&G.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),tt(g.__webglDepthbuffer,y,!1);else{const Y=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,oe),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,oe)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ne(y,g,z){const G=n.get(y);g!==void 0&&Ie(G.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&j(y)}function te(y){const g=y.texture,z=n.get(y),G=n.get(g);y.addEventListener("dispose",x);const Y=y.textures,oe=y.isWebGLCubeRenderTarget===!0,le=Y.length>1;if(le||(G.__webglTexture===void 0&&(G.__webglTexture=i.createTexture()),G.__version=g.version,a.memory.textures++),oe){z.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer[Z]=[];for(let Q=0;Q<g.mipmaps.length;Q++)z.__webglFramebuffer[Z][Q]=i.createFramebuffer()}else z.__webglFramebuffer[Z]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer=[];for(let Z=0;Z<g.mipmaps.length;Z++)z.__webglFramebuffer[Z]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(le)for(let Z=0,Q=Y.length;Z<Q;Z++){const ue=n.get(Y[Z]);ue.__webglTexture===void 0&&(ue.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&Ve(y)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let Z=0;Z<Y.length;Z++){const Q=Y[Z];z.__webglColorRenderbuffer[Z]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[Z]);const ue=r.convert(Q.format,Q.colorSpace),Re=r.convert(Q.type),me=S(Q.internalFormat,ue,Re,Q.normalized,Q.colorSpace,y.isXRRenderTarget===!0),fe=ze(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,me,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Z,i.RENDERBUFFER,z.__webglColorRenderbuffer[Z])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),tt(z.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(oe){t.bindTexture(i.TEXTURE_CUBE_MAP,G.__webglTexture),$e(i.TEXTURE_CUBE_MAP,g);for(let Z=0;Z<6;Z++)if(g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)Ie(z.__webglFramebuffer[Z][Q],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Q);else Ie(z.__webglFramebuffer[Z],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);d(g)&&E(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(le){for(let Z=0,Q=Y.length;Z<Q;Z++){const ue=Y[Z],Re=n.get(ue);let me=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(me=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(me,Re.__webglTexture),$e(me,ue),Ie(z.__webglFramebuffer,y,ue,i.COLOR_ATTACHMENT0+Z,me,0),d(ue)&&E(me)}t.unbindTexture()}else{let Z=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(Z=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Z,G.__webglTexture),$e(Z,g),g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)Ie(z.__webglFramebuffer[Q],y,g,i.COLOR_ATTACHMENT0,Z,Q);else Ie(z.__webglFramebuffer,y,g,i.COLOR_ATTACHMENT0,Z,0);d(g)&&E(Z),t.unbindTexture()}y.depthBuffer&&j(y)}function ge(y){const g=y.textures;for(let z=0,G=g.length;z<G;z++){const Y=g[z];if(d(Y)){const oe=A(y),le=n.get(Y).__webglTexture;t.bindTexture(oe,le),E(oe),t.unbindTexture()}}}const pe=[],Ne=[];function we(y){if(y.samples>0){if(Ve(y)===!1){const g=y.textures,z=y.width,G=y.height;let Y=i.COLOR_BUFFER_BIT;const oe=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,le=n.get(y),Z=g.length>1;if(Z)for(let ue=0;ue<g.length;ue++)t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer);const Q=y.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let ue=0;ue<g.length;ue++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),Z){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,le.__webglColorRenderbuffer[ue]);const Re=n.get(g[ue]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Re,0)}i.blitFramebuffer(0,0,z,G,0,0,z,G,Y,i.NEAREST),l===!0&&(pe.length=0,Ne.length=0,pe.push(i.COLOR_ATTACHMENT0+ue),y.depthBuffer&&y.resolveDepthBuffer===!1&&(pe.push(oe),Ne.push(oe),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ne)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,pe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Z)for(let ue=0;ue<g.length;ue++){t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,le.__webglColorRenderbuffer[ue]);const Re=n.get(g[ue]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,Re,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const g=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function ze(y){return Math.min(s.maxSamples,y.samples)}function Ve(y){const g=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function D(y){const g=a.render.frame;u.get(y)!==g&&(u.set(y,g),y.update())}function st(y,g){const z=y.colorSpace,G=y.format,Y=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||z!==Ys&&z!==Fn&&(je.getTransfer(z)===it?(G!==Qt||Y!==Ht)&&Fe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",z)),g}function Je(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=X,this.getTextureUnits=q,this.setTextureUnits=L,this.setTexture2D=W,this.setTexture2DArray=K,this.setTexture3D=ie,this.setTextureCube=ae,this.rebindTextures=ne,this.setupRenderTarget=te,this.updateRenderTargetMipmap=ge,this.updateMultisampleRenderTarget=we,this.setupDepthRenderbuffer=j,this.setupFrameBufferTexture=Ie,this.useMultisampledRTT=Ve,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function K_(i,e){function t(n,s=Fn){let r;const a=je.getTransfer(s);if(n===Ht)return i.UNSIGNED_BYTE;if(n===Za)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ka)return i.UNSIGNED_SHORT_5_5_5_1;if(n===mc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===_c)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===dc)return i.BYTE;if(n===pc)return i.SHORT;if(n===Ji)return i.UNSIGNED_SHORT;if(n===Ya)return i.INT;if(n===un)return i.UNSIGNED_INT;if(n===an)return i.FLOAT;if(n===bn)return i.HALF_FLOAT;if(n===gc)return i.ALPHA;if(n===xc)return i.RGB;if(n===Qt)return i.RGBA;if(n===Tn)return i.DEPTH_COMPONENT;if(n===Jn)return i.DEPTH_STENCIL;if(n===vc)return i.RED;if(n===$a)return i.RED_INTEGER;if(n===jn)return i.RG;if(n===Ja)return i.RG_INTEGER;if(n===Qa)return i.RGBA_INTEGER;if(n===ks||n===Vs||n===Gs||n===Hs)if(a===it)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Vs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ra||n===aa||n===oa||n===la)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ra)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===aa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===la)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ca||n===ha||n===ua||n===fa||n===da||n===Xs||n===pa)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ca||n===ha)return a===it?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ua)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===fa)return r.COMPRESSED_R11_EAC;if(n===da)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Xs)return r.COMPRESSED_RG11_EAC;if(n===pa)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ma||n===_a||n===ga||n===xa||n===va||n===Ma||n===Sa||n===ya||n===Ea||n===ba||n===Ta||n===Aa||n===wa||n===Ra)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ma)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===_a)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ga)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===xa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===va)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ma)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Sa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ya)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ea)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ba)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ta)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Aa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===wa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ra)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ca||n===Pa||n===Da)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ca)return a===it?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Pa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Da)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===La||n===Ia||n===qs||n===Ua)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===La)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ia)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===qs)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ua)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Qi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const $_=`
void main() {
